	...
	return (
		<div>
			...
			<div>
				...
				<div className='-top-32 mx-10 relative grid grid-cols-8 gap-5'>
					<div className='col-span-2 bg-zinc-800 text-zinc-300 text-sm'>
						<img src={data?.image} alt={""} className='object-cover w-full h-80' />
						<div className='px-2'>
					...
					<div className='col-span-6 ml-5 mt-12'>
						...
						<div className='text-zinc-300 mt-10 text-4xl'>{data?.title.english}</div>
						<div className='text-zinc-300 mt-10 text-sm'>
							Genres: <span className='text-blue-300'>{data?.genres.join(" ,")}</span>
						</div>
						<Routes />
